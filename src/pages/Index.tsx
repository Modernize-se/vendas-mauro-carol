      ...
      <main className="flex-grow pt-24">
          ...
          <div className="container mx-auto px-4 h-full flex flex-col md:flex-row items-center relative z-10">
            <div className="max-w-2xl mb-8 md:mb-0">
              ...
              <p className="text-lg md:text-xl text-muted-foreground mb-8 staggered-item">
                Estamos vendendo os itens que escolhemos com tanto cuidado para
                montar nosso lar, pois estamos de mudança para Londres e não
        ...
        <section id="story" className="container mx-auto px-4 mb-24 pt-24">
          <div className="text-center mb-12">
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto">
              Um capítulo se fecha e outro se abre com nossa mudança para
              Londres.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-secondary/30 p-6 rounded-xl text-center">
              ...
              <p className="text-muted-foreground">
                Em abril de 2023, montamos nosso primeiro lar juntos. Cada item
                que estamos vendendo foi escolhido com carinho para esse momento
                especial. São peças de qualidade que nos acompanharam em
            ...
            <div className="bg-secondary/30 p-6 rounded-xl text-center">
              ...
              <p className="text-muted-foreground">
                Em abril de 2025, embarcaremos em uma nova aventura em Londres
                e, infelizmente, não podemos levar nossos móveis e
                eletrodomésticos conosco. Nossa mudança está se aproximando
                rapidamente!
              </p>
            </div>
            ...
            <div className="bg-secondary/30 p-6 rounded-xl text-center">
              ...
              <h3 className="text-xl font-medium mb-3">
                Novo Lar para Nossas Coisas
              </h3>
              <p className="text-muted-foreground">
                Queremos que esses itens encontrem um novo lar onde serão tão
                amados quanto foram por nós. Cada peça tem sua história e
                esperamos que continue a criar memórias.
              </p>
            </div>
          </div>
        </section>
        ...
        <section id="products" className="container mx-auto px-4 mb-24">
          <div className="text-center mb-12">
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto">
              Confira os itens que estamos vendendo antes da nossa mudança para
              Londres.
            </p>
          </div>
        ...
        <section id="how-it-works" className="container mx-auto px-4 mb-24">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="bg-secondary/30 p-8 rounded-xl">
              ...
              <p className="text-muted-foreground">
                Os produtos foram escolhidos com muito carinho e cuidado para
                nosso lar.
              </p>
            </div>
          </div>
