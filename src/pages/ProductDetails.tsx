      ...
      <div className="min-h-screen flex flex-col">
        ...
        <main className="flex-grow pt-24 container mx-auto px-4">
          <div className="max-w-2xl mx-auto text-center py-16">
            <h1 className="text-3xl font-display font-medium mb-4">Produto não encontrado</h1>
      ...
      <main className="flex-grow pt-24">
        <div className="container mx-auto px-4">
                      ...
                      <tbody>
                        {Object.entries(product.specifications).map(([key, value]) => (
                          <tr key={key} className="border-b border-border last:border-0">
                            <td className="py-3 px-4 font-medium bg-secondary/50">{key}</td>
          ...
          {relatedProducts.length > 0 && (
            <div className="mb-16">
              <h2 className="text-2xl font-display font-medium mb-6">Produtos Relacionados</h2>
