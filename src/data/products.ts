...
export const products: Product[] = [
  {
    ...
    description:
      "LavSec Samsumg WD11T 11KG IX1. Em perfeito estado de funcionamento, comprada recentemente. Ideal para otimizar espaço e tempo na rotina de lavagem.",
    salePrice: 3500.0,
    referencePrice: 5084.9,
    imageUrls: [
  ...
  },
  {
    ...
    description:
      "Purificador Electrolux Eletrônico Experience com Pure 4x e Painel Digital Bivolt Cinza PE12G. Água pura e saborosa a qualquer momento, fácil instalação.",
    salePrice: 800.0,
  ...
  },
  {
    ...
    description:
      "Cafeteira Oster Flavor Inox Programável - 127V. Prepare cafés deliciosos com programação de horário. Design elegante que combina com qualquer cozinha.",
    salePrice: 200.0,
    referencePrice: 328.9,
    imageUrls: [
  ...
  },
  {
    ...
    description:
      "Forno de Micro-ondas Solo 30L PRETO 127V. Descongelamento rápido e aquecimento eficiente. Painel digital de fácil utilização.",
    salePrice: 600.0,
    referencePrice: 900.0,
    imageUrls: [
  ...
  },
  {
    ...
    description:
      "Sofá cinza suede veludo 2.70m - 2 módulos 1.20m e 2 braços 15cm. Confortável e elegante, ideal para sala de estar. Tecido de alta qualidade e estrutura resistente.",
    salePrice: 5000.0,
  ...
  },
  {
    ...
    description:
      "Mesa de Jantar Acapulco 180x90 Off White com pés Natural. Elegante e espaçosa, perfeita para refeições em família ou receber amigos.",
    salePrice: 1200.0,
  ...
  },
  {
    ...
    description:
      "Conjunto 6 cadeiras estofadas linho cinza - pés de madeira cor natural. Combinam perfeitamente com a mesa de jantar, proporcionando conforto durante as refeições.",
    salePrice: 1500.0,
    referencePrice: 2200.0,
    imageUrls: [
  ...
  },
  {
    ...
    name: "Buffet Lizz",
    description:
      "Buffet Lizz 1.90 Off White/Cedro. Móvel versátil para armazenamento e decoração, com acabamento refinado e portas que facilitam a organização dos itens.",
    salePrice: 500.0,
    referencePrice: 779.9,
    imageUrls: [
  ...
  },
  {
    ...
    description:
      "Rack com Painel para TV até 75 polegadas com LED Sublime 220cm Gelius Movies Off White/Natural. Unidade de entretenimento completa com iluminação LED.",
    salePrice: 800.0,
  ...
  },
  {
    ...
    description:
      "Mesa de Escritório Kuandra Carvalho - A 75cm x L 180cm x P 70cm. Espaçosa e elegante, perfeita para home office ou estudo.",
    salePrice: 300.0,
  ...
  },
  {
    ...
    description:
      "Mesa de Escritório Studio Carvalho A 75cm x L 150cm X P 50cm. Design funcional e minimalista, ideal para espaços menores.",
    salePrice: 150.0,
  ...
  },
  {
    ...
    description:
      "Cadeira Escritório Diretor Ergonômica NR17 Tela Mesh Tóquio 3329 Preto. Conforto superior para longas horas de trabalho, com ajustes de altura e reclinação.",
    salePrice: 400.0,
  ...
  },
  {
    ...
    description:
      'Monitor Dell P2210T (22") + Cabo Display Port. Excelente para trabalho e estudo, com boa resolução e qualidade de imagem.',
    salePrice: 400.0,
  ...
  },
  {
    ...
    description:
      "Puff Banqueta Redondo Luxo - Tecido Cinza Noturno. Versátil, pode ser usado como assento extra ou mesa de apoio. Design elegante que combina com qualquer ambiente.",
    salePrice: 150.0,
    referencePrice: 269.9,
    imageUrls: [
  ...
  },
  {
    ...
    description:
      "Cama Box Baú Bipartido Queen Star Flex Blindado Pistão Linha Hotel 30cm Prof. Interna E Externa 48cm já com pés de 6cm cor Cinza escuro tecido nylon grosso imita linho. Espaçosa e funcional com amplo espaço para armazenamento.",
    salePrice: 1000.0,
    referencePrice: 1470.0,
    imageUrls: [
  ...
  },
  {
    ...
    description:
      "Colchão Estate Firm Cross System 28cm - Stearns Foster 1.58x1.98 M. Conforto excepcional com sistema de molas ensacadas para melhor suporte.",
    salePrice: 1800.0,
    referencePrice: 2790.0,
    imageUrls: [
  ...
  },
  {
    ...
    description:
      'Smart TV Samsumg 55" UHD 55AU7700 4K Processador Crystal Wi-Fi Tizen Comando de Voz. Imagem cristalina e recursos inteligentes para sua sala.',
    salePrice: 1800.0,
  ...
  },
  {
    ...
    name: 'TV LED TCL 32"',
    description:
      'TV 32" Led HD 32S615 HDR/WIFI. Ideal para quartos ou ambientes menores, com boa qualidade de imagem e recursos de Smart TV.',
    salePrice: 800.0,
    referencePrice: 1199.0,
    imageUrls: [
  ...
  },
  {
    ...
    description:
      "Kit de banheiro acrílico com 6 peças lançamento + BANHO E DECOR - Branco Perolado + Lixo. Conjunto completo para organização e decoração do seu banheiro.",
    salePrice: 200.0,
  ...
  },
  {
    ...
    description:
      "KIT LAVABO BANHEIRO LUXO VIDRO 5 + Lixo PECAS Cor: PRETO PRETO. Elegante conjunto que traz sofisticação ao seu banheiro com acabamento premium.",
    salePrice: 300.0,
  ...
  },
  {
    ...
    description:
      "Kit de Bancada para Banheiro Cerâmica Madeira de Bamboo Clara Fudji Sensea 3 peças + Lixo. Une funcionalidade e estética natural ao seu banheiro.",
    salePrice: 250.0,
  ...
  },
  {
    ...
    description:
      "Varal de Chão Com Abas Retrátil Slim Preto. Prático e dobrável, economiza espaço quando não está em uso. Ideal para apartamentos.",
    salePrice: 60.0,
  ...
  },
  {
    ...
    description:
      "Varal Mágico 74cm com 4 varetas - alumínio - Branco. Solução compacta para secar roupas, pode ser recolhido quando não está em uso.",
    salePrice: 150.0,
    referencePrice: 229.9,
    imageUrls: [
      "https://images.unsplash.com/photo-1574706472779-8006b1c8622f?q=80&w=1374&auto=format&fit=crop",
      "https://images.unsplash.com/photo-1600585152220-90363fe7e115?q=80&w=1470&auto=format&fit=crop",
    ],
  ...
  },
  {
    ...
    description:
      "Aspirador De Pó Robô Com Sensor Multilaser - Vermelho. Autonomia na limpeza diária, com sensores que evitam obstáculos e quedas.",
    salePrice: 300.0,
    referencePrice: 450.0,
    imageUrls: [
  ...
  },
  {
    ...
    description:
      "Aspirador de Pó e Água Vertical Sem Fio WAP Acqua Mob 2 em 1. Versatilidade para limpar diferentes superfícies, com bateria recarregável para maior liberdade de movimento.",
    salePrice: 250.0,
  ...
  },
  {
    ...
    description:
      "Banqueta Giratória Milano Cinza. Design contemporâneo, ideal para bancadas de cozinha ou ilhas. Possui altura ajustável e base resistente.",
    salePrice: 250.0,
    referencePrice: 395.0,
    imageUrls: [
  ...
  },
  {
    ...
    description:
      "Blender Oster Myblend, 2 Jarras, Preto 110V, 250W, BLSTPB-BBL. Perfeito para preparar shakes de proteína e sucos. Compacto e portátil.",
    salePrice: 150.0,
    referencePrice: 250.0,
    imageUrls: [
  ...
  },
  {
    ...
    description:
      "Piano Digital Stage CDP-S110 BK com Suporte para Piano Digital. Som de alta qualidade e teclado com resposta ao toque similar a um piano acústico.",
    salePrice: 2200.0,
    referencePrice: 3290.0,
    imageUrls: [
  ...
  },
  {
    ...
    description:
      "Kit 6 Organizadores de geladeira 2,2L e um porta frios. Cor Transparente/branco. Otimize o espaço da sua geladeira e mantenha tudo organizado e de fácil acesso.",
    salePrice: 180.0,
